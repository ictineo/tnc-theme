...
if(is_numeric(strpos($item['class'], 'date-box'))) {
  $item['entry'] = "<div class='num-day'>". date('d', strtotime($item['date'])) . "</div><span class='strs'><div class='month'>" . t(date('F', strtotime($item['date']))) . "</div><div class='txt-day'>". t(date('l', strtotime($item['date']))) . "</div></span>";
}
?>
